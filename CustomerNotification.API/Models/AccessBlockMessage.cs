...
{
    public class AccessBlockMessage : Message
    {
        public AccessBlockMessage() : base()
        {
            this.MessageType = MessageTypes.UserBlocked;
        }
        public AccessBlockBody MessageBody { get; set; }
        ...
        public override string GenerateMessage()
        {
            if (this.MessageFormat == MessageFormats.JSON)
            {
                ...
                this.FormattedMessage.Append(@"""messageType"":" + @"""" + MessageTypes.UserBlocked.ToString() + @"""" + Environment.NewLine);
            ...
            {
                this.FormattedMessage.Append(@"""" + MessageTypes.UserBlocked.ToString() + @""",""" + MessageBody.UserId + @"""" + Environment.NewLine);
            }
            else // XML
            {
                ...
                this.FormattedMessage.Append(@"<messageType>" + MessageTypes.UserBlocked.ToString() + @"</messageType>" + Environment.NewLine);
                this.FormattedMessage.Append(@"<data>" + Environment.NewLine);
